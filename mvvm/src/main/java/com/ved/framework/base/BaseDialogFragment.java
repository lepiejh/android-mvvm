 ...
 */
public abstract class BaseDialogFragment<V extends ViewDataBinding, VM extends BaseViewModel<? extends BaseModel>>
        extends RxDialogFragment implements Host<V, VM> {
