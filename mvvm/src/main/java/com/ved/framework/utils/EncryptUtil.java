...
/**
 * 加密工具类，提供 DES-CBC 加解密。
 * <p>
 * 其他加密算法已拆分为独立工具类：
 * <ul>
 *   <li>{@link Md5Util} — MD5 单向加密</li>
 *   <li>{@link Base64Util} — Base64 编码/解码</li>
 *   <li>{@link AESUtil} — AES 加密解密</li>
 *   <li>{@link DesUtil} — DES 加密解密</li>
 *   <li>{@link RsaUtil} — RSA 非对称加密解密</li>
 *   <li>{@link ThreeDes} — 3DES ECB 辅助类</li>
 *   <li>{@link AesCbcUtil} — AES-CBC 对称加密</li>
 *   <li>{@link ThreeDesCbcUtil} — 3DES-CBC 对称加密</li>
 * </ul>
 */
